...
public class Ahorcado extends javax.swing.JFrame {
    ...
    public Ahorcado() {
        ...
        msgs[0] = "ESCALAR".toUpperCase();
        msgs[1] = "TRANSPUESTA".toUpperCase();
        msgs[2] = "DIAGONAL".toUpperCase();
        msgs[3] = "SUPERIOR".toUpperCase();
        msgs[4] = "INFERIOR".toUpperCase();
        msgs[5] = "TRIANGULAR".toUpperCase();
        msgs[6] = "COLUMNA".toUpperCase();
        msgs[7] = "FILA".toUpperCase();
        msgs[8] = "NULA".toUpperCase();
        msgs[9] = "OPUESTA".toUpperCase();
        msgs[10] = "SIMETRICA".toUpperCase();
        msgs[11] = "ANTISIMETRICA".toUpperCase();
        msgs[12] = "IDENTICA".toUpperCase();
        msgs[13] = "CUADRADA".toUpperCase();
        msgs[14] = "mxn".toUpperCase();
        msgs[15] = "Matriz".toUpperCase();
        msgs[16] = "Orden".toUpperCase();
        msgs[17] = "Constante".toUpperCase();
        msgs[18] = "CERO".toUpperCase();
        msgs[19] = "IGUAL".toUpperCase();
    ...
    private void initComponents() {
        ...
        jButton19.setBackground(new java.awt.Color(51, 255, 204));
