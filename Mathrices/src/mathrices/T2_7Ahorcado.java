...
public class T2_7Ahorcado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1110, 410));
        setUndecorated(true);
        ...
        jLabel2.setText("LAS PALABRAS CORRECTAS DEL AHORCADO SON CON BASE A LA TEORIA ");
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(T2_7Ahorcado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new T2_7Ahorcado().setVisible(true);
            }
        });
    }
