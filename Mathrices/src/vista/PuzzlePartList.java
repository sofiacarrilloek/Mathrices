 ...
 public PuzzlePartList(BufferedImage bimage, int x_parts, int y_parts, Dimension random_size)
  ...
  for(i = 0; i < piezasArray.length; i++)
     ...
     if(node.west != null)
       ...
       float ys2 = ys - 20;
       float center = ys + 20;
       float yf  = (float)(destDraw.height/2.0 + 25.0);
       float yf2 = yf + 20;

       gp.moveTo (0, ys);
       gp.curveTo(-6, ys, -6, ys2, -13, ys2);
       gp.curveTo(-32, ys2, -40, ys, -40, center);
       gp.curveTo(-40, yf, -32,  yf2, -26, yf2);
       ...
       node.boundsImage.translate(-40, 0);
       node.boundsImage.width += 40;
       }
     ...
     if(node.east != null)
       ...
       gp.curveTo(x-32, ys2, x-40, ys, x-40, center);
       gp.curveTo(x-40, yf, x-32,  yf2, x-26, yf2);
     ...
     if(node.north != null)
       ...
       gp.curveTo(xs2, -32, xs, -40, center, -40);
       ...
       node.boundsImage.translate(0, -40);
       node.boundsImage.height += 40;
       }
...
//Corte interno
       ...
       gp.curveTo(xs2, y-32, xs, y-40, center, y-40);
